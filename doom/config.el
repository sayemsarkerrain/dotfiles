...
(setq org-roam-capture-templates
      '(("j" "journal")
        ("jd" "day" plain "%?"
         :if-new (file+head "journal/daily/${slug}.org"
                            "#+title: ${title}\ncreated: %U\n")
         :immediate-finish t
         :unnarrowed t)
        ("jw" "week" plain "%?"
         :if-new (file+head "journal/weekly/${slug}.org"
                            "#+title: ${title}\ncreated: %U\n")
         :immediate-finish t
         :unnarrowed t)
        ("jq" "quarter" plain "%?"
         :if-new (file+head "journal/quarterly/${slug}.org"
                            "#+title: ${title}\ncreated: %U\n")
         :immediate-finish t
         :unnarrowed t)
        ("jy" "quarter" plain "%?"
         :if-new (file+head "journal/yearly/${slug}.org"
                            "#+title: ${title}\ncreated: %U\n")
         :immediate-finish t
         :unnarrowed t)
        ("s" "source")
        ("sa" "article" plain "%?"
         :if-new (file+head "sources/articles/${slug}.org"
                            "#+title: ${title}\ncreated: %U\n")
         :immediate-finish t
         :unnarrowed t)
        ("sb" "book" plain "%?"
         :if-new (file+head "sources/books/${slug}.org"
                            "#+title: ${title}\ncreated: %U\n")
         :immediate-finish t
         :unnarrowed t)
        ("sv" "video" plain "%?"
         :if-new (file+head "sources/videos/${slug}.org"
                            "#+title: ${title}\ncreated: %U\n")
         :immediate-finish t
         :unnarrowed t)
        ("n" "note" plain "%?"
